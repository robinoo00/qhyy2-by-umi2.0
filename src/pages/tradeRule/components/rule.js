...
class Example extends React.Component{
    state = {
        list:[
            {label:'原油',value:'CL',comp:<TradeYuanYou/>},
            {label:'纽金',value:'GC',comp:<TradeGC/>},
            ...
            {label:'小型恒生指数',value:'MHI',comp:<TradeMHI/>},
    ...
    render(){
        return(
            <div>
                ...
                />
                <div className={styles["mod-trade-rule"]}>
                    {this.state.showComp}
                    <div>
